...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post managers_url, params: { manager: { create: @manager.create, destroy: @manager.destroy, employee_id: @manager.employee_id, manager_id: @manager.manager_id } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { create: @manager.create, destroy: @manager.destroy, employee_id: @manager.employee_id, manager_id: @manager.manager_id } }
